...
export type ClientSDK = {
  Query: {
    ...
    encounterMethod: { args: QueryEncounterMethodArgs, resolve: Query["encounterMethod"] },
    encounterMethods: { resolve: Query["encounterMethods"] },
    evolutionChain: { args: QueryEvolutionChainArgs, resolve: Query["evolutionChain"] },
    evolutionChains: { resolve: Query["evolutionChains"] },
    evolutionTrigger: { args: QueryEvolutionTriggerArgs, resolve: Query["evolutionTrigger"] },
